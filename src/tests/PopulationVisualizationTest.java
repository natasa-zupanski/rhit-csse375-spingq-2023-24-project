...
public class PopulationVisualizationTest {
    ...
    public void TestDrawOn ()
    {
        ...
        "SetColor: BLACK\n" +
        "DrawLine: x1:50 y1:345 x2:50 y2:355\n" +
        "DrawString: 0 x:40 y:370\n" +
        "DrawLine: x1:45 y1:350 x2:55 y2:350\n" +
        "DrawString: 0 x:25 y:355\n" +
        "DrawLine: x1:150 y1:345 x2:150 y2:355\n" +
        "DrawString: 1 x:140 y:370\n" +
        "DrawLine: x1:45 y1:320 x2:55 y2:320\n" +
        "DrawString: 10 x:25 y:325\n" +
        "DrawLine: x1:250 y1:345 x2:250 y2:355\n" +
        "DrawString: 2 x:240 y:370\n" +
        "DrawLine: x1:45 y1:290 x2:55 y2:290\n" +
        "DrawString: 20 x:25 y:295\n" +
        "DrawLine: x1:350 y1:345 x2:350 y2:355\n" +
        "DrawString: 3 x:340 y:370\n" +
        "DrawLine: x1:45 y1:260 x2:55 y2:260\n" +
        "DrawString: 30 x:25 y:265\n" +
        "DrawLine: x1:450 y1:345 x2:450 y2:355\n" +
        "DrawString: 4 x:440 y:370\n" +
        "DrawLine: x1:45 y1:230 x2:55 y2:230\n" +
        "DrawString: 40 x:25 y:235\n" +
        "DrawLine: x1:550 y1:345 x2:550 y2:355\n" +
        "DrawString: 5 x:540 y:370\n" +
        "DrawLine: x1:45 y1:200 x2:55 y2:200\n" +
        "DrawString: 50 x:25 y:205\n" +
        "DrawLine: x1:650 y1:345 x2:650 y2:355\n" +
        "DrawString: 6 x:640 y:370\n" +
        "DrawLine: x1:45 y1:170 x2:55 y2:170\n" +
        "DrawString: 60 x:25 y:175\n" +
        "DrawLine: x1:750 y1:345 x2:750 y2:355\n" +
        "DrawString: 7 x:740 y:370\n" +
        "DrawLine: x1:45 y1:140 x2:55 y2:140\n" +
        "DrawString: 70 x:25 y:145\n" +
        "DrawLine: x1:850 y1:345 x2:850 y2:355\n" +
        "DrawString: 8 x:840 y:370\n" +
        "DrawLine: x1:45 y1:110 x2:55 y2:110\n" +
        "DrawString: 80 x:25 y:115\n" +
        "DrawLine: x1:950 y1:345 x2:950 y2:355\n" +
        "DrawString: 9 x:940 y:370\n" +
        "DrawLine: x1:45 y1:80 x2:55 y2:80\n" +
        "DrawString: 90 x:25 y:85\n" +
        "DrawLine: x1:1050 y1:345 x2:1050 y2:355\n" +
        "DrawString: 10 x:1040 y:370\n" +
        "DrawLine: x1:45 y1:50 x2:55 y2:50\n" +
        "DrawString: 100 x:25 y:55\n" +
        "SetStroke: BasicStroke Width: 2\n" +
        "DrawLine: x1:50 y1:350 x2:1050 y2:350\n" +
        "DrawLine: x1:50 y1:50 x2:50 y2:350\n" +
        "SetColor: GRAY\n" +
        "SetStroke: BasicStroke Width: 1\n" +
        "DrawLine: x1:50 y1:200 x2:350 y2:200\n" +
        "SetStroke: BasicStroke Width: 2\n" +
        "SetColor: GREEN\n" +
        "DrawLine: x1:50 y1:200 x2:150 y2:230\n" +
        "SetColor: ORANGE\n" +
        "DrawLine: x1:50 y1:320 x2:150 y2:290\n" +
        "SetColor: RED\n" +
        ...
        "SetColor: ORANGE\n" +
        "DrawLine: x1:150 y1:290 x2:250 y2:230\n" +
        "SetColor: RED\n" +
        ...
        "SetColor: ORANGE\n" +
        "DrawLine: x1:250 y1:230 x2:350 y2:320\n" +
        "SetColor: RED\n" +
    ...
    public void TestDrawOn_LearningChance ()
    {
        ...
        "SetColor: CYAN\n" +
        "DrawLine: x1:50 y1:200 x2:150 y2:194\n" +
        "SetColor: LIGHT_GRAY\n" +
        "DrawLine: x1:50 y1:335 x2:150 y2:350\n" +
        "SetColor: GREEN\n" +
        "DrawLine: x1:150 y1:230 x2:250 y2:260\n" +
        "SetColor: ORANGE\n" +
        "DrawLine: x1:150 y1:290 x2:250 y2:230\n" +
        ...
        "SetColor: CYAN\n" +
        "DrawLine: x1:150 y1:194 x2:250 y2:194\n" +
        "SetColor: LIGHT_GRAY\n" +
        "DrawLine: x1:150 y1:350 x2:250 y2:350\n" +
        "SetColor: GREEN\n" +
        "DrawLine: x1:250 y1:260 x2:350 y2:200\n" +
        "SetColor: ORANGE\n" +
        "DrawLine: x1:250 y1:230 x2:350 y2:320\n" +
        ...
        "SetColor: CYAN\n" +
        "DrawLine: x1:250 y1:194 x2:350 y2:200\n" +
        "SetColor: LIGHT_GRAY\n" +
        "DrawLine: x1:250 y1:350 x2:350 y2:335\n";
        assertEquals(expectedString, populationVisualization.getDrawValueString());
    }
}
