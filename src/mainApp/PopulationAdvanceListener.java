 ...
 *         </br>
 *         Purpose: Used to handle updates to the various viewers as the timer
 *         increases
 *         </br>
 *         Restrictions: None
 *         </br>
 *         For example: PopulationAdvanceListener advanceListener = new
 *         PopulationAdvanceListener(population, fittestOrganism,
 *         populationViewer, generationViewer);
 */
public class PopulationAdvanceListener implements ActionListener {
	...
	/**
	 * ensures: initializes the population component to c, the fittest organism
	 * viewer to o, the population viewer to v, and the generation viewer to g
	 * 
